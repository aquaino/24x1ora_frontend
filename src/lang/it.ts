export default {
  ...
  teams: {
    ...
    paymentHolder: 'Intestatario',
    paymentReceiptData: 'Dati ricevuta di pagamento',
    paymentReceiptDescription: 'Ai sensi della normativa vigente siamo obbligati a emettere ricevuta per i pagamenti superiori a 77€. Queste informazioni saranno trattate esclusivamente al fine di emettere la ricevuta di pagamento e subito cancellate dai nostri archivi.',
  ...
  auth: {
    ...
    askForgotPassword: 'Hai dimenticato la password?',
    resetPassword: 'Reimpostala ora',
    ...
    passwordResetRequestSuccess:
      "Riceverai a breve un'e-mail con il link per l'impostazione della nuova password. Controlla anche la casella della posta indesiderata.",
    passwordResetSuccess: 'Password aggiornata con successo! Accedi ora con le nuove credenziali.',
